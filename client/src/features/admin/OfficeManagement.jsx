              ...
              <Card variant="outlined" sx={{ height: '100%' }}>
                <CardContent>
                  ...
                  <Typography variant="caption" display="block" sx={{ mt: 2, color: 'text.secondary' }}>
                    Lat: {Number(office.latitude || 0).toFixed(4)}, Lng: {Number(office.longitude || 0).toFixed(4)}
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
        ...
        <Grid container spacing={3}>
          ...
          <Grid size={{ xs: 12, md: 7 }}>
            ...
            <MapPicker
              ...
              radius={Number(form.geofenceRadius) || 200}
              setLocation={(pos) => {
                const updates = { latitude: pos.lat, longitude: pos.lng };
                if (pos.address) updates.address = pos.address;
